...
## Binding rules
- **Every blueprint carries the five sections** (What / Why / When / Proven in / How to
  re-instantiate) and its provenance names at least one repo where the pattern actually ran.
  The validator enforces both; a pattern without a proving ground is an idea, not a blueprint.
- **Abstractions never outrun their evidence.** A blueprint describes what shipped, cites where,
  and stops. Speculative extensions go to the consuming repo's own gates.
